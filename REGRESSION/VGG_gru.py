...
class FERANet(nn.Module):
	def __init__(self):
		...
		self.gru = nn.GRU(4096,128, batch_first=True)#(sequence length, batch, input size),(num_layers * num_directions, batch, hidden_size)batch_firs, If True, then the input and output tensors are provided as (batch, seq, feature)
